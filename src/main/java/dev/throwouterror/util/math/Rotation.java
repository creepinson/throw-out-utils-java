...
public enum Rotation {
	...
	public static Rotation getRotation(Tensor vec) {
		if (vec.x() > 0)
	...
	public static class RotationMatrix {
		...
		public Tensor transform(Tensor triple) {
