...
public class Range4D {
    ...
    public boolean hasPlayerInRange(IPlayer player) {
        ...
        // Ignore height for partial Cubic chunks support as range comparision gets used
        // ignoring player height normally anyways
        int radius = 32 * 16;
    ...
    public boolean equals(Object obj) {
        return obj instanceof Range4D && ((Range4D) obj).xMin == xMin && ((Range4D) obj).yMin == yMin
                && ((Range4D) obj).zMin == zMin && ((Range4D) obj).xMax == xMax && ((Range4D) obj).yMax == yMax
